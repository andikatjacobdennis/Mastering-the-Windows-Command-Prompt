...
<span style="color: red;">Use the command prompt with caution, as some commands can recursively delete files and folders or cause irreparable damage to your PC.</span>
